...
const SubscribedVideosSkeletonDesktop = () => (
...
const SubscribedVideosSkeletonMobile = () => (
...
const SubscribedVideosSkeleton = () => {
  ...
  return isMobile ? (
    <SubscribedVideosSkeletonMobile />
  ) : (
    <SubscribedVideosSkeletonDesktop />
  );
};

// Videos content component
const SubscribedVideosContent = () => {
