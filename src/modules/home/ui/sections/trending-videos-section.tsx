...
const TrendingVideosSkeletonDesktop = () => (
...
const TrendingVideosSkeletonMobile = () => (
...
const TrendingVideosSkeleton = () => {
  ...
  return isMobile ? (
    <TrendingVideosSkeletonMobile />
  ) : (
    <TrendingVideosSkeletonDesktop />
  );
};

// Videos content component
const TrendingVideosContent = () => {
